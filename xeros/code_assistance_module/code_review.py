...
class SolanaCodeReviewer:
    ...
    async def _check_security(self, code: str) -> List[Dict[str, str]]:
        ...
        if "pub" in code and "require!" not in code:
            security_issues.append({
                "type": "access_control",
                "severity": "high",
                "description": "Public function without access control check",
                "suggestion": "Add require! macro to validate caller permissions"
            })
